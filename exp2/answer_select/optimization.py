...
def optimization(loss,
    ...
    if warmup_steps > 0:
        ...
        optimizer = fluid.optimizer.Adam(learning_rate=scheduled_lr, epsilon=1e-6, grad_clip=fluid.clip.GradientClipByGlobalNorm(clip_norm=1.0))
    else:
        optimizer = fluid.optimizer.Adam(learning_rate=learning_rate, epsilon=1e-6, grad_clip=fluid.clip.GradientClipByGlobalNorm(clip_norm=1.0))
