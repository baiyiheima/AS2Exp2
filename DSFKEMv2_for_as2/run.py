...
model_g.add_arg("transformer_h",int,8,"")
model_g.add_arg("transformer_dim",int,968,"")
model_g.add_arg("transformer_n",int,1,"")
    ...
    for k in range(epoch):
        ...
        for i in range(len(batch_train_inputs)):
            ...
            outputs = model(True,
                            ...
                            wn_concept_ids,
                            nell_concept_ids,
                            data_processer.train_wn_max_concept_length,
                            data_processer.train_nell_max_concept_length )
