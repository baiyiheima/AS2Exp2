...
parser.add_argument("--output_dir", default='../data/SelQA/tokenization/tokens', type=str,
                    help="The output directory to dump tokenization results.")
parser.add_argument("--train_file",
                    default='../data/SelQA/tagged/selqa_train.tagged.json', type=str,
                    help="")
parser.add_argument("--dev_file",
                    default='../data/SelQA/tagged/selqa_dev.tagged.json', type=str,
                    help="")
parser.add_argument("--test_file",
                    default='../data/SelQA/tagged/selqa_test.tagged.json', type=str,
                    help="")
...
if __name__ == '__main__':
    ...
    for do_lower_case in (True, False):
        ...
        with open(os.path.join(args.output_dir,'selqa.train.tokenization.{}.data'.format('uncased' if do_lower_case else 'cased')),'wb') as fout:
        ...
        with open(os.path.join(args.output_dir,'selqa.dev.tokenization.{}.data'.format('uncased' if do_lower_case else 'cased')),'wb') as fout:
        ...
        with open(os.path.join(args.output_dir,'selqa.test.tokenization.{}.data'.format('uncased' if do_lower_case else 'cased')),'wb') as fout:
