...
if __name__ == '__main__':
    train_filename = "../data/WikiQA/raw/wikic_train.tsv"
    dev_filename = "../data/WikiQA/raw/wikic_valid.tsv"
    test_filename = "../data/WikiQA/raw/wikic_test.tsv"

    train_object = read_data(train_filename, 'train')
    result_train = {}
    result_train["data"] = train_object
    train_output_path = '../data/WikiQA/json/wikic_train.json'
    ...
    dev_output_path = '../data/WikiQA/json/wikic_dev.json'
    ...
    test_output_path = '../data/WikiQA/json/wikic_test.json'
