...
def parse_args():
    ...
    parser.add_argument("--output_dir", default='../data/SelQA/tagged', type=str,
                        help="The output directory to store tagging results.")
    parser.add_argument("--train_file", default='../data/SelQA/json/selqa_train.json', type=str,
                        help="")
    parser.add_argument("--predict_file", default='../data/SelQA/json/selqa_dev.json', type=str,
                        help="")
    parser.add_argument("--test_file", default='../data/SelQA/json/selqa_test.json', type=str,
                        help="")
